...
**Key highlights:**
- 12 sequential Bash scripts covering the full MongoDB fundamentals workflow
- Full CRUD operations (Create, Read, Update, Delete) on `orders`, `customers`, and `products` collections
- Embedded vs. referenced document modeling with practical trade-off analysis
- JSON Schema validation enforced at the database level
